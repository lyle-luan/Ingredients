...
function cut () {
  ...
  self.setBoundStyle = function (ref) {
    ...
    var boundOption = [
      {
        start: { x: x - half, y: y + 15 - half },
        step1: { x: x - half, y: y - half },
        step2: { x: x + 15 - half, y: y - half }
      },
      {
        start: { x: x - half, y: y + height - 15 + half },
        step1: { x: x - half, y: y + height + half },
        step2: { x: x + 15 - half, y: y + height + half }
      },
      {
        start: { x: x + width - 15 + half, y: y - half },
        step1: { x: x + width + half, y: y - half },
        step2: { x: x + width + half, y: y + 15 - half }
      },
      {
        start: { x: x + width + half, y: y + height - 15 + half },
        step1: { x: x + width + half, y: y + height + half },
        step2: { x: x + width - 15 + half, y: y + height + half }
      }
    ];
